...
# # Disaply on Imege from the train 
# #  
...
model = ViT().to(device)  # Make sure the model is moved to the GPU

# you need to download the folder from the repo
...
# Save the  model (Save only weights)
torch.save(vit.state_dict(), 'd:/temp/Guava_vit_model_weights2.pth')  # Save only weights
